...
CREATE TABLE IF NOT EXISTS public.resumes (
  ...
  section_order jsonb NULL DEFAULT '["professional_summary", "skills", "work_experience", "projects", "education", "certifications"]'::jsonb,
  section_configs jsonb NULL DEFAULT '{"professional_summary": {"visible": true}, "skills": {"style": "grouped", "visible": true}, "projects": {"visible": true, "max_items": 3}, "education": {"visible": true, "max_items": null}, "certifications": {"visible": true}, "work_experience": {"visible": true, "max_items": null}}'::jsonb,
  created_at timestamp with time zone NOT NULL DEFAULT timezone('utc'::text, now()),
  updated_at timestamp with time zone NOT NULL DEFAULT timezone('utc'::text, now()),
  ...
  template text NULL DEFAULT 'classic',
