...
import {
  ...
  FilePlus,
  Star,
} from "lucide-react"; // Import Star, remove UsersRound
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {tailoredResumes.toLocaleString()}
                </div>
              </CardContent>
            </Card>
    ...
    return (
      <div className="container mx-auto py-10 px-4 md:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-red-600">
          Admin Page Server Error
        </h1>
        <p className="text-muted-foreground mt-1">
          An unexpected error occurred while trying to render the admin
        ...
        <p className="mt-4 text-sm text-gray-600">
          Please check the server logs for more information. The client-side
          portion of the page may not function correctly.
        </p>
      </div>
    );
  }
