    ...
    <div className="container py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <Button variant="destructive" size="sm" asChild>
          <Link href={`/admin/impersonate/${targetUserId}`}>
            Impersonate User
          </Link>
        </Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription>
              User account details from Supabase Auth.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Data from the &apos;subscriptions&apos; table.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            {subscription ? (
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                  <DetailItem
                    label="Plan"
                    value={subscription.subscription_plan}
                  >
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              List of resumes created by this user.
            </CardDescription>
          </CardHeader>
          <CardContent>
