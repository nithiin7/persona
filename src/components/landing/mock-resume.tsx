...
export function MockResume() {
  return (
    <Card
      className="w-full max-w-[6in] aspect-[8.5/11] bg-white relative p-6 font-sans 
    ...
    >
      ...
      {/* Technical Skills */}
      <div className="mb-4">
        <h3 className="text-[10px] font-bold text-gray-900 mb-1.5 uppercase tracking-wider border-b border-gray-200 pb-1">
          Technical Skills
        </h3>
        <div className="flex flex-wrap gap-1">
          <Badge
            variant="secondary"
            className="bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-[10px] py-0"
          >
          ...
          <Badge
            ...
            className="bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-[10px] py-0"
          >
            Cloud: AWS (S3, Lambda, EC2), Vercel
          </Badge>
          <Badge
            variant="secondary"
            className="bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-[10px] py-0"
        ...
        <div className="space-y-3">
          <div>
            ...
            <ul className="text-[10px] text-gray-600 list-disc list-outside ml-3 space-y-0.5">
              <li>
                Developed and maintained key features for legal practice
                management platform using React and TypeScript
              </li>
              <li>
                Implemented AI-powered document analysis feature reducing manual
                review time by 60%
              </li>
              <li>
                Optimized API performance resulting in 30% faster page load
                times
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-[10px] text-gray-600 list-disc list-outside ml-3 space-y-0.5">
              ...
              <li>
                Collaborated on social media analytics features serving 100K+
                users
              </li>
              <li>
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          <div>
            ...
            <ul className="text-[10px] text-gray-600 list-disc list-outside ml-3 space-y-0.5">
              <li>
                Built meeting summarization tool using OpenAI API, Next.js, and
                TypeScript
              </li>
              <li>
          ...
          <div>
            <div className="flex justify-between items-baseline">
              <h4 className="text-[11px] font-semibold text-gray-800">
                Vancouver Housing Market Analyzer
              </h4>
              <p className="text-[10px] text-gray-600">
            ...
            <ul className="text-[10px] text-gray-600 list-disc list-outside ml-3 space-y-0.5">
              <li>
                Created web scraper and analysis tool for Vancouver real estate
                listings
              </li>
              <li>
                Built interactive dashboard using Next.js, TailwindCSS, and
                Chart.js
              </li>
            </ul>
          </div>
