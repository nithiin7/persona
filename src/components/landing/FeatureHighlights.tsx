    ...
    <section className="py-24 md:py-32 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          >
            Smart AI tools that optimize your resume for each job, increasing
            your interview chances by up to{" "}
            <span className="font-semibold text-teal-700">3x</span>
          </motion.p>
        </motion.div>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 max-w-4xl mx-auto opacity-80">
          {companies.map((company, index) => (
            <div
              key={index}
              className="w-24 h-12 relative transition-all duration-300"
            >
              <Image
                src={company.logo}
                alt={company.name}
      ...
      >
        <div className="max-w-3xl mx-auto px-6 py-12 rounded-2xl bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-lg border border-white/40 shadow-xl">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join 50,000+ professionals who are getting more interviews with
            Persona
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <AuthDialog>
              <button className="px-8 py-4 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-lg font-medium shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="md:hidden fixed bottom-4 left-0 right-0 z-50 px-4">
        <AuthDialog>
          <button className="flex items-center justify-center w-full py-3.5 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium shadow-lg">
            Get Started Now
          </button>
        </AuthDialog>
      </div>
