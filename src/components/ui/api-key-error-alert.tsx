...
export function ApiKeyErrorAlert({ error, router }: ApiKeyErrorAlertProps) {
  ...
  console.log(
    "Contains OpenAI API key not found:",
    errorString.includes("OpenAI API key not found") ||
      errorJson.includes("OpenAI API key not found")
  );
  console.log(
  ...
  console.log(
    ...
    errorString.includes("Incorrect API key provided") ||
      errorJson.includes("invalid_api_key")
  );
  console.log(
    "Contains Rate limit:",
    errorString.includes("Rate limit exceeded") ||
      errorJson.includes("Rate limit exceeded")
  );
  console.groupEnd();
