        ...
        >
          ...
          {imageOverflowRight && (
            ...
            >
              ...
              {badgeText && (
                <div
                  className={`inline-block self-end px-4 py-1 rounded-full bg-gradient-to-r ${badgeGradient} border-purple-200/40 text-purple-700 text-sm font-medium mb-1`}
                >
          ...
          {!imageOverflowRight && (
            ...
            >
              ...
              {badgeText && (
                <div
                  className={`inline-block px-4 py-1 rounded-full bg-gradient-to-r ${badgeGradient} border-purple-200/40 text-purple-700 text-sm font-medium mb-1`}
                >
                  <div className="flex items-center">
                    <span className="mr-2">{badgeText}</span>
                    <Star className="w-3.5 h-3.5 fill-current" />
